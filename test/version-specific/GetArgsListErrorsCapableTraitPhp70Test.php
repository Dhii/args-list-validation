 ...
 * @since [*next-version*]
 */
class GetArgsListErrorsCapableTraitPhp70Test extends TestCase
{
    /**
    ...
    /**
     * Tests that `_getArgsListErrors()` works as expected when comparing hinted native types.
     *
     * @requires PHP 7.0
     *
     * @since [*next-version*]
     */
    public function testGetArgsListErrorsTypeNative()
    {
        $closure = function (string $arg0, int $arg1) {
        };
    ...
    /**
     * Tests that `_getArgsListErrors()` works as expected when comparing hinted custom types.
     *
     * @requires PHP 7.0
     *
     * @since [*next-version*]
     */
    public function testGetArgsListErrorsTypeCustom()
    {
        $closure = function (\ArrayIterator $arg0, \ArrayIterator $arg1) {
        };
        $args = [new \ArrayIterator([]), uniqid('arg1')];
        $refl = new ReflectionFunction($closure);
        $spec = $refl->getParameters();
