 ...
 * @since [*next-version*]
 */
class GetArgsListErrorsCapableTrait71Test extends TestCase
{
    /**
    ...
    /**
     * Tests that `_getArgsListErrors()` works as expected when comparing nullable custom types.
     *
     * @requires PHP 7.1
     *
     * @since [*next-version*]
     */
    public function testGetArgsListErrorsTypeNullable()
    {
        $closure = function (\ArrayIterator $arg0, ?\ArrayIterator $arg1, ?\ArrayIterator $arg2) {
        };
        $args = [new \ArrayIterator([]), null];
        ...
        $this->assertRegExp('!^Argument #2 is required$!', $result[0], 'Wrong error reported');
    }
}
